...
public class Seg {
    ...
    private void initColor(final int distance, final int cc) {
        ...
        case 0:
            ...
            setColor(MazePanel.getColor(rgbValue, RGB_DEF, RGB_DEF));
            break;
        case 1:
            //setColor(new Color(RGB_DEF, rgbValue, RGB_DEF));
            setColor(MazePanel.getColor(RGB_DEF, rgbValue, RGB_DEF));
            break;
        case 2:
            //setColor(new Color(RGB_DEF, RGB_DEF, rgbValue));
            setColor(MazePanel.getColor(RGB_DEF, RGB_DEF, rgbValue));
            break;
        case 3:
            //setColor(new Color(rgbValue, rgbValue, RGB_DEF));
            setColor(MazePanel.getColor(rgbValue, rgbValue, RGB_DEF));
            break;
        case 4:
            //setColor(new Color(RGB_DEF, rgbValue, rgbValue));
            setColor(MazePanel.getColor(RGB_DEF, rgbValue, rgbValue));
            break;
        case 5:
            //setColor(new Color(rgbValue, RGB_DEF, rgbValue));
            setColor(MazePanel.getColor(rgbValue, RGB_DEF, rgbValue));
            break;
        default:
            //setColor(new Color(RGB_DEF, RGB_DEF, RGB_DEF));
            setColor(MazePanel.getColor(RGB_DEF, RGB_DEF, RGB_DEF));
            break;
        }
    }
    ...
    public boolean equals(final Object other) {
        ...
        if ((dist != o.dist) || (partition != o.partition) || (seen != o.seen)
                || (MazePanel.getRGB(col) != MazePanel.getRGB(o.col))) {
            return false;
        }
