...
public class Cells {
	...
	/**
	 * new method added for BasicRobot use
	 * use the same method as hasBorder method
	 * @param position x
	 * @param position y
	 * @param Cardinal Direction dir
	 * @return boolean  if there's a border
	 */
	public boolean hasBorderCardinal(int x, int y,CardinalDirection dir) {
		return hasMaskedBitsTrue(x, y, getBoundForBit(getCWConstantForDirection(dir)) );
	}
